 ...
 * @param tokenOutRate rate of zToken at request creation time
 */
struct Request {
    address sender;
    address tokenIn;
...
interface IDepositVault is IManageableVault {
     ...
     */
    event SetMinZTokenAmountForFirstDeposit(
     ...
     * @param minted amount of minted zTokens
     ...
     * @param amountUsd amount of tokenIn converted to USD
     * @param fee fee amount in tokenIn
     * @param tokenOutRate zToken rate
     * @param referrerId referrer id
     */
    ...
    /**
     * @param requestId mint request id
     * @param newOutRate zToken rate inputted by admin
     */
     ...
     * with the current zToken rate.
     * Does same validation as `safeApproveRequest`.
     * Mints zToken to request users.
     ...
     * Sets request flags to Processed.
     * @param requestIds request ids array
     * @param newOutRate new zToken rate inputted by vault admin
     */
     ...
     * @param newOutRate zToken rate inputted by vault admin
     */
     ...
     */
    function setMinZTokenAmountForFirstDeposit(uint256 newValue) external;
