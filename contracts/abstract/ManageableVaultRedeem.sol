...
import "../interfaces/IManageableVaultRedeem.sol";
    ...
    WithSanctionsList
{
     ...
     * @notice zToken token
     */
    IZToken public zToken;

    /**
     * @notice zToken data feed contract
     */
    IDataFeed public zTokenDataFeed;

    /**
     * @notice address to which tokens and zTokens will be sent
     */
    ...
    function __ManageableVaultRedeem_init(
        address _ac,
        ...
        _validateAddress(_zTokenInitParams.zToken, false);
        _validateAddress(_zTokenInitParams.zTokenDataFeed, false);
        ...
        zToken = IZToken(_zTokenInitParams.zToken);
        __Pausable_init(_ac);
        ...
        zTokenDataFeed = IDataFeed(_zTokenInitParams.zTokenDataFeed);
    }

    /**
     * @inheritdoc IManageableVaultRedeem
     */
     ...
     * @inheritdoc IManageableVaultRedeem
     */
    function setInstantDailyLimit(
        uint256 newInstantDailyLimit
    ) external onlyVaultAdmin {
     ...
     * @param amount operation amount (decimals 18)
     */
    function _requireAndUpdateAllowance(
        address token,
        uint256 amount
    ) internal {
